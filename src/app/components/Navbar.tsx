...
export function Navbar({ isDark, toggleTheme, logoDark, logoLight }: NavbarProps) {
  ...
  // ✅ PROPER SOLUTION - scrollIntoView use karo
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        ...
        {/* Desktop Links */}
        <div
          className={`hidden md:flex items-center gap-6 lg:gap-8 px-6 py-2 rounded-full border transition-all duration-300 ${isDark
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className={`md:hidden relative z-50 overflow-hidden border-t ${isDark
            ...
            >
              <div className="px-4 sm:px-6 py-4 sm:py-6 flex flex-col gap-1 sm:gap-2 max-h-[calc(100vh-80px)] overflow-y-auto">
                ...
                <motion.div
                  ...
                  className={`text-xs font-medium py-2 px-3 sm:px-4 rounded-lg ${isDark ? "text-gray-400" : "text-gray-500"
                    }`}
                >
